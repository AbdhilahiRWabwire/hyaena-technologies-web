...
export {
    ...
    queryAllHTMLContactAddress,
    queryAllHTMLImageMapArea,
    queryAllHTMLArticleContents,
    queryAllHTMLAside,
    queryAllHTMLEmbedAudio,
    queryAllHTMLBringAttentionTo,
    queryAllHTMLDocumentBaseURL,
    queryAllHTMLBidirectionalIsolate,
    queryAllHTMLBidirectionalTextOverride,
    queryAllHTMLBlockQuotation,
    queryAllHTMLDocumentBody,
    queryAllHTMLLineBreak,
    queryAllHTMLButton,
    queryAllHTMLGraphicsCanvas,
    queryAllHTMLTableCaption,
    queryAllHTMLCitation,
    queryAllHTMLInlineCode,
    queryAllHTMLTableColumn,
    queryAllHTMLTableColumnGroup,
    queryAllHTMLData,
    queryAllHTMLDataList,
    queryAllHTMLDescriptionDetails,
    queryAllHTMLDeletedText,
    queryAllHTMLDetailsDisclosure,
    queryAllHTMLDefinition,
    queryAllHTMLDialog,
    queryAllHTMLContentDivision,
    queryAllHTMLDescriptionList,
    queryAllHTMLDescriptionTerm,
    queryAllHTMLEmphasis,
    queryAllHTMLEmbedExternalContent,
    queryAllHTMLFieldSet,
    queryAllHTMLFigureCaption,
    queryAllHTMLFigureWithOptionalCaption,
    queryAllHTMLFooter,
    queryAllHTMLForm,
    queryAllHTMLSectionHeading,
    queryAllHTMLDocumentMetadataHeader,
    queryAllHTMLHeader,
    queryAllHTMLHeadergGroup,
    queryAllHTMLThematicBreakHorizontalRule,
    queryAllHTMLDocumentRoot,
    queryAllHTMLIdiomaticText,
    queryAllHTMLInlineFrame,
    queryAllHTMLImageEmbed,
    queryAllHTMLInput,
    queryAllHTMLInsertedText,
    queryAllHTMLKeyboardInput,
    queryAllHTMLLabel,
    queryAllHTMLFieldSetLegend,
    queryAllHTMLListItem,
    queryAllHTMLExternalResourceLink,
    queryAllHTMLMain,
    queryAllHTMLImageMap,
    queryAllHTMLMarkText,
    queryAllHTMLMenu,
    queryAllHTMLMetadata,
    queryAllHTMLMeter,
    queryAllHTMLNavigationSection,
    queryAllHTMLNoScript,
    queryAllHTMLExternalObject,
    queryAllHTMLOrderedList,
    queryAllHTMLOptionGroup,
    queryAllHTMLOption,
    queryAllHTMLOutput,
    queryAllHTMLParagraph,
    queryAllHTMLPicture,
    queryAllHTMLPreformattedText,
    queryAllHTMLProgressIndicator,
    queryAllHTMLInlineQuotation,
    queryAllHTMLRubyFallbackParenthesis,
    queryAllHTMLRubyText,
    queryAllHTMLRubyAnnotation,
    queryAllHTMLStrikeThrough,
    queryAllHTMLSampleOutput,
    queryAllHTMLScript,
    queryAllHTMLGenericSearch,
    queryAllHTMLGenericSection,
    queryAllHTMLSelect,
    queryAllHTMLWebComponentSlot,
    queryAllHTMLSideComment,
    queryAllHTMLMediaOrImageSource,
    queryAllHTMLContentSpan,
    queryAllHTMLStrongImportance,
    queryAllHTMLStyleInformation,
    queryAllHTMLSubScript,
    queryAllHTMLDisclosureSummary,
    queryAllHTMLSuperScript,
    queryAllHTMLTable,
    queryAllHTMLTableBody,
    queryAllHTMLTableDataCell,
    queryAllHTMLContentTemplate,
    queryAllHTMLTextArea,
    queryAllHTMLTableFoot,
    queryAllHTMLTableHeader,
    queryAllHTMLTableHead,
    queryAllHTMLDateTime,
    queryAllHTMLDocumentTitle,
    queryAllHTMLTableRow,
    queryAllHTMLEmbedTextTrack,
    queryAllHTMLUnarticulatedAnnotationUnderline,
    queryAllHTMLUnorderedList,
    queryAllHTMLVariable,
